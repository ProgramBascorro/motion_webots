...
def generate_launch_description():
    ...
    scan_gate_node = Node(
        ...
        parameters=[{
            ...
            "close_range_m":   1.5,   # hapus range < 1.5m (mode near)
            "full_close_range": 2.0,  # hapus range < 2.0m (mode full/penalty box)
            "field_half_len":   4.5,
    ...
    goal_localizer_node = Node(
        ...
        parameters=[{
            ...
            "goal_height_m":           1.2,
            # Aktivasi: hanya ketika robot dekat gawang
            ...
            # Koreksi covariance (x lebih percaya, y kurang pasti)
            "cov_x":    0.06,
            "cov_y":    0.12,
            "cov_yaw":  0.10,
            "cooldown_sec": 1.5,
